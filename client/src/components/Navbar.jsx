      ...
      >
        <div className="container">
          <Link to="/nike" className="nike-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 308.72 161.06">
              <defs>
                <style></style>
              </defs>
              <title>Nike</title>
          ...
          <Link to="/adidas" className="adidas-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 355.73 236.69">
              <title>Adidas</title>
              <g id="Layer_2" data-name="Layer 2">
                <g id="Layer_1-2" data-name="Layer 1">
          ...
          <Link to="/vans" className="vans-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.75 117.85">
              <defs>
                <style></style>
              </defs>
              <title>Vans</title>
      ...
      >
        <div className="container">
          <Link to="/stockX" className="nike-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 235.82 106.49">
              <defs>
                <style></style>
              </defs>
