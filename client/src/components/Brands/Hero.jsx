...
const Hero = ({ brands }) => {
  const Brandlogo = () => {
    if (brands === "nike") {
    ...
    } else if (brands === "converse") {
      return (
        <svg
          className="svg-main conversesvg"
          id="store--logo"
          viewBox="0 0 805.4 94"
        >
      ...
      return (
        <svg
          className="svg-main newbalance-main"
          xmlns="http://www.w3.org/2000/svg"
    ...
    } else if (brands === "reebok") {
      return (
        <svg
          className="svg-main reebok-main"
          xmlns="http://www.w3.org/2000/svg"
