...
const Brandlogosvg = ({ brand }) => {
  if (brand === "Nike" || brand === "Jordan") {
    ...
    return (
      <svg
        className="brand-logo adidas svg"
        xmlns="http://www.w3.org/2000/svg"
    ...
    return (
      <svg
        className="brand-logo converse svg"
        id="store--logo"
    ...
    return (
      <svg
        className="brand-logo svg reebok"
        xmlns="http://www.w3.org/2000/svg"
